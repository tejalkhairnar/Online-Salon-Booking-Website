	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">Salon</span>
			            <h1 class="mb-4">Get An Enhanced Look</h1>
			            <p class="mb-4">We are proud of our high quality work. The products we use are of top quality and branded.</p>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/bg+.png" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">True Beauty</span>
			            <h1 class="mb-4">Beauty Salon</h1>
			            <p class="mb-4">This salon provides multiple facilities with advanced technology equipments and has best quality service. Here we offer the best treatment.</p>
